...
class AccountController extends AbstractController
{
    ...
    #[Route('/{id}/transaction', name: 'account_transactions', methods: ['GET'])]
    public function showTransactions(Account $account){
        array_map(function($el){
            $el->setMontant(-$el->getMontant());
            return $el;
        }, $account->getDebitTransaction()->toArray());
        return $this->renderForm('account/show_transactions.html.twig', [
            'account' => $account
        ]);
    }
}
